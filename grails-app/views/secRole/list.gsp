<%@ page import="it.algos.pubblica.SecRole" %>
<html>
<head>
        ...
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="id"
                                  title="${message(code: 'secRole.id.label', default: 'Id')}"/>
            ...
            <g:each in="${secRoleInstanceList}" status="i" var="secRoleInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="show"
                                id="${secRoleInstance.id}">${fieldValue(bean: secRoleInstance, field: "id")}</g:link></td>
